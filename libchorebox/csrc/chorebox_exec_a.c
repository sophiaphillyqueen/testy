...
// chorebox_exec_a.c - Source-code for this function:
...
void chorebox_exec_a ( char *rg_a, chorebox_str_list *rg_b )
{
  ...
  *lc_putter = NULL;
  ...
  // (NOTE: This last line might get replaced should the
  // chorebox library ever incorporate a linked-list
  // representation of the environment variables.)
  execve(rg_a,lc_neoarg,chorebox_env);
}
